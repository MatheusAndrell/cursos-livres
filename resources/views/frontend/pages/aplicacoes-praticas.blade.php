...
@section('content')
    ...
    <div class="platinum">
        ...
        <div class="text-info-platinum">
            <h1>LOGO</h1>
            <h2>Trend23</h2>
            <p>O nosso curso completo, baseado em aulas práticas, funcionais e poderosas para que você possa aplicar nas
                melhores tendências do mercado em 2023. Você irá aprender do zero, tudo o que precisa saber para poder
                ingressar nessa carreira de sucesso.</p>
        </div>
    </div>
