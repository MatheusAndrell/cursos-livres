...
return array (
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'first_name' => 'Primeiro nome',
          'group' => 'Grupo',
          'group_sort' => 'Classificação de grupo',
          'groups' => 
          array (
            'name' => 'Nome do grupo',
          ),
      ...
      array (
        'general_settings' => 
        array (
          'app_locale' => 'Localidade do aplicativo',
          'app_name' => 'Nome do aplicativo',
          'app_timezone' => 'Fuso horário do aplicativo',
          'app_url' => 'URL do aplicativo',
          'captcha_site_key' => 'Captcha Key',
          'captcha_site_secret' => 'Captcha Secret',
          'captcha_status' => 'Status do Captcha',
          ...
          'lesson_timer' => 'Temporizador de Lição',
          'mail_driver' => 'Mail Driver',
          'mail_from_address' => 'Correio do Endereço',
          'mail_from_name' => 'Nome do e-mail',
          'mail_host' => 'Host de e-mail',
          'mail_password' => 'Senha de e-mail',
          'mail_port' => 'Porta de correio',
          'mail_username' => 'Nome de usuário de e-mail',
          'one_signal_push_notification' => 'Configuração OneSignal',
          'onesignal_code' => 'Cole o código do script OneSignal aqui',
          'password_expires_days' => 'Senha expira dias',
          'password_history' => 'Histórico de Senha',
          'requires_approval' => 'Requer Aprovação',
          'retest_status' => 'Testar Novamente',
        ...
        array (
          ...
          array (
            ...
            'label' => 'Status de login do Bitbucket',
          ...
          array (
            'client_id' => 'ID do Cliente',
            'client_secret' => 'Segredo do Cliente',
            'label' => 'Status de login do Facebook',
            'redirect' => 'URL de redirecionamento',
          ),
          'github' => 
          array (
            'client_id' => 'ID do Cliente',
            'client_secret' => 'Segredo do Cliente',
            'label' => 'Status de login do Github',
            'redirect' => 'URL de redirecionamento',
          ),
          'google' => 
          array (
            'client_id' => 'ID do Cliente',
            'client_secret' => 'Segredo do Cliente',
            'label' => 'Status de login do Google',
            'redirect' => 'URL de redirecionamento',
          ),
          'linkedin' => 
          array (
            ...
            'client_secret' => 'Segredo do Cliente',
            'redirect' => 'URL de redirecionamento',
            'label' => 'Status de login do Linkedin',
          ),
          'twitter' => 
          array (
            'client_secret' => 'Segredo do Cliente',
            'client_id' => 'ID do Cliente',
            'redirect' => 'URL de redirecionamento',
            'label' => 'Status de login do Twitter',
          ),
        ),
      ),
    ),
    ...
    array (
      ...
      'new_password_confirmation' => 'Nova senha confirmada',
      'old_password' => 'Senha anterior',
      'other' => 'Outro',
      'password' => 'Senha',
      'password_confirmation' => 'Confirmação de senha',
      'payment_information' => 'Confirmação de pagamento',
